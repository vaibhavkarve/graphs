...
def _(expr: Expr, x: _ArrayExpr): # -> Zero | ZeroArray:
    ...

@array_derive.register(ArrayTensorProduct)
def _(expr: ArrayTensorProduct, x: Expr): # -> Zero:
    ...

@array_derive.register(ArraySymbol)
def _(expr: ArraySymbol, x: _ArrayExpr): # -> PermuteDims | Zero | ZeroArray:
    ...

@array_derive.register(MatrixSymbol)
def _(expr: MatrixSymbol, x: _ArrayExpr): # -> PermuteDims | Zero | ZeroArray:
    ...

@array_derive.register(Identity)
def _(expr: Identity, x: _ArrayExpr): # -> Zero | ZeroArray:
    ...

@array_derive.register(OneMatrix)
def _(expr: OneMatrix, x: _ArrayExpr): # -> Zero | ZeroArray:
    ...
