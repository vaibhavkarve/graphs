...
@public
def bernoulli_poly(n, x=..., polys=...): # -> PurePoly | Poly:
...
@public
def bernoulli_c_poly(n, x=..., polys=...): # -> PurePoly | Poly:
...
@public
def genocchi_poly(n, x=..., polys=...): # -> PurePoly | Poly:
...
@public
def euler_poly(n, x=..., polys=...): # -> PurePoly | Poly:
...
@public
def andre_poly(n, x=..., polys=...): # -> PurePoly | Poly:
