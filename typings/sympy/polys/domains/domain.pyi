...
class Domain:
    ...
    def __getitem__(self, symbols): # -> PolynomialRing:
        """The mathematical way to make a polynomial ring. """
        ...
    
    def poly_ring(self, *symbols, order=...): # -> PolynomialRing:
        """Returns a polynomial ring, i.e. `K[X]`. """
        ...
    
    def frac_field(self, *symbols, order=...): # -> FractionField:
        """Returns a fraction field, i.e. `K(X)`. """
        ...
    
    def old_poly_ring(self, *symbols, **kwargs): # -> GlobalPolynomialRing | GeneralizedPolynomialRing:
        """Returns a polynomial ring, i.e. `K[X]`. """
        ...
    
    def old_frac_field(self, *symbols, **kwargs): # -> FractionField:
        """Returns a fraction field, i.e. `K(X)`. """
        ...
